...
if __name__ == "__main__":
    ...
    set_seeds(args.seed)
    out_file = f'{args.out_dir}/{args.model_name}_{args.data_name}_aug{args.aug}_aug-sample{args.aug_sample}_aug-num{args.aug_num}_seed{args.seed}.th'
    ...
    val_data, train_data = select_data(args, train=True, aug=args.aug, aug_num=args.aug_num)
